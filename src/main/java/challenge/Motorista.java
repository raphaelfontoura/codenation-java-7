...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
        	if (idade < 0) throw new IllegalArgumentException("Idade incorreta.");
            this.idade = idade;
            return this;
        }

        public MotoristaBuilder withPontos(int pontos) {
        	if (pontos < 0) throw new IllegalArgumentException("Não pode pontos negativos.");
            this.pontos = pontos;
            return this;
        }
        ...
        public Motorista build() {
        	if (habilitacao.isEmpty()) throw new NullPointerException("Motorista sem habilitação.");
        	if (nome.isEmpty()) throw new NullPointerException("Motorista sem nome informado.");
